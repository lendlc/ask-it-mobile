...
class _$_LoginResponse extends _LoginResponse {
  ...
  @override
  String toString() {
    return 'LoginResponse(token: $token, id: $id, fullName: $fullName, role: $role)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, token, id, fullName, role);
...
abstract class _LoginResponse extends LoginResponse {
  const factory _LoginResponse(
      ...
      required final String role}) = _$_LoginResponse;
